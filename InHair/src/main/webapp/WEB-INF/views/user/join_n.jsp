        ...
        <form class="form-horizontal" id="formJoin" action="${ctx}/user/join" method="POST">
            <table width="600" border="0" align="center">
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="id" id="iptLoginId" maxlength="10" placeholder=" 아이디">
                        <div id="dplPrint"></div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input class="form-control" style="width:420px; height:35px" type="password" maxlength="10" name="password" id="iptPassword"
                               placeholder="비밀번호"></td>
                </tr>
                <tr>
                    <td><label for="textfield">PASSWORD CHECK</label></td>
                    <td><input  class="form-control"style="width:420px; height:35px" type="password" maxlength="10" name="rePassword" id="iptRePassword"
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="name" id="iptName" maxlength="10" placeholder=" 이름"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="email" id="iptEmail" maxlength="25" placeholder=" 이메일"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="phonenum" id="iptPhone" maxlength="13" placeholder=" 000-0000-0000"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
