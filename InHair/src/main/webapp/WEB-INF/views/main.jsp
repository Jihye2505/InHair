...
<body>
	...
	<div class="container">
		...
		<input type="hidden" id="oldGu" value="${gu}"> <input
			type="hidden" id="oldSi" value="${si}">
		<table class="table" style="border: hidden">
			<tr>
				<td class="table-condensed"><label for="location1"
					class="control-label">검색</label></td>
				<form action="${ctx }/hairshop/hairshopSearchByName" method="POST">
					<td><input type="text" class="form-control" name="name"
						id="name" aria-describedby="basic-addon1" placeholder="상호명"></td>
					<td><input type="submit" class="btn btn-danger" value="검색"></td>
				</form>
				<form action="${ctx}/hairshop/hairshopSearchByAddress" method="POST">
					<td class="table-condensed" align="right">
					...
					<td align="left" width="10px"><input type="submit"
	...
	<div class="container">
		...
		<div class="row text-center" style="margin: auto;">
			<div class="container">
				<c:forEach items="${hairshopList }" var="shop">
					<form action="${ctx }/hairshop/detail" method="POST">
						<div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
							<div class="card hovercard">
								<img src="${ctx}/hairshop/image?shopCode=${shop.code}" /> <br>
								<br>
								<div class="info">
									<div class="title">${shop.shopName}</div>
									<div class="desc">${shop.intro}</div>
								</div>
