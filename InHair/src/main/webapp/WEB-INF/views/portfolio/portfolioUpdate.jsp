...
<script type="text/javascript">
	...
	var create = function() {
		if (validate()) {
			document.getElementById("portfolioUpdate").submit();
		}
	};
</script>
		...
		<div>
			...
			<div class="well">
				...
				<form class="form-horizontal"
					action="${ctx}/portfolio/update?portfolio_id=${portfolio.portfolio_id}"
					method="post" id="portfolioUpdate" enctype="multipart/form-data">
					<input id="designer_id" name="designer_id" type="hidden"
						value="${portfolio.designer_id}">
					...
					<table width="600" border="0" align="center">
						<tbody>
							<tr>
								...
								<td><input class="form-control" type="title" name="title"
									id="iptPassword" value="${portfolio.title }"></td>
							...
							<tr>
								...
								<td><input type="text" class="form-control" name="content"
									id="content" value="${portfolio.content}"></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
