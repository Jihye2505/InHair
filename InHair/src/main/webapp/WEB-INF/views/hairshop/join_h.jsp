	...
	<div class="container">
		...
		<div class="well">
			...
			<form class="form-horizontal" id="formJoin"
				action="${ctx}/hairshop/join" method="POST" enctype="multipart/form-data">
				<table width="600" border="0" align="center">
					<tbody>
						<tr>
							<td><label for="textfield">CODE</label></td>
							<td><input class="form-control" type="text" name="code"
								id="code" placeholder=" 점포코드" maxlength="50" >
								<div id="dplPrint"></div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="100"><input class="form-control" type="password"
								style="width: 95%; height: 35px" maxlength="20" maxlength="10" name="password"
						...
						<tr>
							...
							<td><input class="form-control"
								...
								name="rePassword" maxlength="10" id="iptRePassword" placeholder="비밀번호 확인"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><input class="form-control" maxlength="13" type="text" name="tel"
						...
						<tr>
							...
							<td>
								<div>
									<select style="margin: 20px; width: 170px;" id="si" name="si">
										<option value="">시/도</option>
										<option value="서울특별시">서울특별시</option>

									</select> <select style="margin: 25px; width: 170px;" id="gu" name="gu">
										...
										name="address" id="address" maxlength="85"  placeholder=" 상세주소">
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div style="margin: 20px">
									<select style=" width: 130px;" name="open" id="open">
									...
									</select>   ~   <select style="margin: 20px; width: 130px;" name="close" id="close">
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="shopName"
								id="shopname" placeholder=" 상호명" maxlength="100" ></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><input class="form-control" type="text" maxlength="100" name="intro"
								id="intro"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
				...
				<div align="center">
					...
					<input type="reset" class="btn btn-success" value="취소"> <input
						...
						onclick="join(); return false;" id="okButton"> <br>
				</div>
			</form>
			<br>
		</div>
	...
	<script type="text/javascript">
		...
		$("#code").keyup(function() {
	       if($(this).val().length < 5) {
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/hairshop/codeCheck",
				data : {
					"code" : $("#code").val()
				},
