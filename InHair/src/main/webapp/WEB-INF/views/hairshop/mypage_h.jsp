...
<body>
	<div class="container">
		...
		<div class="well">
			...
			<form class="form-horizontal" id="formJoin" action="${ctx}/hairshop/update" method="POST" enctype="multipart/form-data">
					...
					<tbody>
						<tr>
							...
							<td width="100"><input class="form-control"
								style="width: 410px; height: 35px" type="password"
								name="password" id="iptPassword" maxlength="10" placeholder="비밀번호"></td>
						...
						<tr>
							...
							<td><input class="form-control"
								style="width: 410px; height: 35px" type="password"
								name="rePassword" id="iptRePassword" maxlength="10" placeholder="비밀번호 확인"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><input class="form-control" type="text" maxlength="13" name="tel"
								id="phone" placeholder=" 00-000-0000" value="${loginedUser.tel}"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td>
								<div>
									<select style="margin: 20px" id="si" name="si">
										<option value="">시/도</option>
										<option value="서울특별시">서울특별시</option>

									</select> <select id="gu" name="gu">
										...
										name="address" id="address" maxlength="85" placeholder=" 상세주소" value="${loginedUser.address}">
								</div>
							</td>
						...
						<tr>
							...
							<td><input class="form-control" type="text" maxlength="100" name="shopName"
								id="shopname" placeholder="상호명" value="${loginedUser.shopName}"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td><input class="form-control" type="text" maxlength="100" name="intro" value="${loginedUser.intro}"
								id="iptintro"></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
