	...
	<div class="container">
		...
		<div>
			...
			<div class="well">
				...
				<form class="form-horizontal" id="productUpdate"
					action="${ctx }/product/update" method="POST">
					<input type="hidden" id="oldLeadtime" value="${product.leadtime}">
					...
					<table width="600" border="0" align="center">
						<tbody>
							...
							<tr>
								...
								<td style="padding-left: 20px"><select name="leadtime"
									id="leadtime">
							...
							<tr>
								...
								<td><input type="number" class="form-control" name="price"
									id="price" value="${product.price}"></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
...
<script type="text/javascript">
	...
	window.onload = function() {
		document.getElementById("leadtime").value = document
				.getElementById("oldLeadtime").value;
	};
</script>
</body>
</html>